...
def eval_phase_behaviorCwH(H,Tm,rho_i,rho_w,rho_g,cp_i,cp_w,cp_g,C_w,L):
    ...
    #print(phi_w[phi_i>1],phi_i[phi_i>1],T[phi_i>1],dTdH[phi_i>1])
    #####for ice layer
    phi_i[phi_i>=1] = 1.0
    phi_w[phi_i>=1] = 0  #this needs to be redistributed to nearby cells later
    #############
    ...
    phi_w[phi_w>=1] = 1.0 - phi_i[phi_w>=1]
    #phi_i[phi_w>=1] = 0  #this needs to be redistributed to nearby cells later
    # #############
